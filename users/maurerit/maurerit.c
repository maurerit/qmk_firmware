...
void shift_finished (qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (shift_tap_state.state) {
        ...
        case DOUBLE_TAP: register_code(KC_CLCK); break;
        case DOUBLE_HOLD: register_code(KC_LCTL); break;
        case TRIPLE_TAP: register_code(KC_EQL); break;
        case TRIPLE_HOLD: register_code(KC_LALT); break;
        case DOUBLE_SINGLE_TAP: register_code(KC_LSFT); unregister_code(KC_LSFT); register_code(KC_LSFT); break;
        case TRIPLE_SINGLE_TAP: register_code(KC_LSFT); unregister_code(KC_LSFT); register_code(KC_LSFT); unregister_code(KC_LSFT); register_code(KC_LSFT);
...
void shift_reset (qk_tap_dance_state_t *state, void *user_data) {
    switch (shift_tap_state.state) {
        ...
        case DOUBLE_TAP: unregister_code(KC_CLCK); break;
        case DOUBLE_HOLD: unregister_code(KC_LCTL); break;
        case TRIPLE_TAP: unregister_code(KC_EQL); break;
        case TRIPLE_HOLD: unregister_code(KC_LALT);
        case DOUBLE_SINGLE_TAP: unregister_code(KC_LSFT);
        case TRIPLE_SINGLE_TAP: unregister_code(KC_LSFT);
    }
